...
const ReactionsBar: FunctionComponent<ReactionsBarProps> = ({
  ...
  return (
    <div className="relative w-full h-fit flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-6 sm:gap-3 p-2">
        ...
        >
          ...
          {[
            ...
            },
            {
              ...
              title: "Quote",
              function: () =>
                setCommentQuote(commentQuote == "Quote" ? undefined : "Quote"),
